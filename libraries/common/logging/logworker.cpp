...
namespace g2 {
   ...
   LogWorkerImpl::LogWorkerImpl() : _bg(ActiveObject::create()) { }
   ...
   void LogWorkerImpl::bgSave(g2::LogMessagePtr msgPtr) {
      ...
      if (_sinks.empty()) {
         std::string err_msg{"logworker has no sinks. Message: ["};
   ...
   void LogWorkerImpl::bgFatal(FatalMessagePtr msgPtr) {
      ...
      perror("log exited after receiving FATAL trigger. Flush message status: ");
   }
