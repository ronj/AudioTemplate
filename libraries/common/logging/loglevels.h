 ...
 * ============================================================================
 * Filename:g2loglevels.h  Part of Framework for Logging and Design By Contract
...
// 2) Remember to update the initialization of "loglevels.cpp/g_log_level_status"
