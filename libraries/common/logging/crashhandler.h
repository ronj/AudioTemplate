...
// kjell. Separera på crashhandler.h och crashhanlder_internal.h
...
/** Install signal handler that catches FATAL C-runtime or OS signals
  ...
  See the this site for example usage: http://www.tutorialspoint.com/cplusplus/cpp_signal_handling.htm
