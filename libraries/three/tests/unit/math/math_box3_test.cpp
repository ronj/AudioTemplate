...
TEST(math_box3_test, distanceToPoint) {
	...
	EQUAL( a.distanceToPoint( Vector3( 0, 0, 0 ) ), 0);
	EQUAL( a.distanceToPoint( Vector3( 1, 1, 1 ) ), Math::sqrt( 3.f ));
	EQUAL( a.distanceToPoint( Vector3( -1, -1, -1 ) ), Math::sqrt( 3.f ));

	EQUAL( b.distanceToPoint( Vector3( 2, 2, 2 ) ), Math::sqrt( 3.f ));
	EQUAL( b.distanceToPoint( Vector3( 1, 1, 1 ) ), 0);
	EQUAL( b.distanceToPoint( Vector3( 0, 0, 0 ) ), 0);
	EQUAL( b.distanceToPoint( Vector3( -1, -1, -1 ) ), 0);
	EQUAL( b.distanceToPoint( Vector3( -2, -2, -2 ) ), Math::sqrt( 3.f ));
}
