...
TEST(math_box2_test, distanceToPoint) {
	...
	EQUAL(0, a.distanceToPoint( Vector2( 0, 0 ) ));
	EQUAL(Math::sqrt( 2.f ), a.distanceToPoint( Vector2( 1, 1 ) ));
	EQUAL(Math::sqrt( 2.f ), a.distanceToPoint( Vector2( -1, -1 ) ));

	EQUAL( b.distanceToPoint( Vector2( 2, 2 ) ) , Math::sqrt( 2.f ) );
	EQUAL( b.distanceToPoint( Vector2( 1, 1 ) ) , 0 );
	EQUAL( b.distanceToPoint( Vector2( 0, 0 ) ) , 0 );
	EQUAL( b.distanceToPoint( Vector2( -1, -1 ) ), 0 );
	EQUAL( b.distanceToPoint( Vector2( -2, -2 ) ), Math::sqrt( 2.f ) );
}
