...
public:
  virtual ~IAudioCodec() {}
  virtual std::size_t decode(TSample* aSamples, std::size_t aSampleCount) const = 0;
  virtual std::size_t encode(const TSample* aSamples, std::size_t aSampleCount) const = 0;
